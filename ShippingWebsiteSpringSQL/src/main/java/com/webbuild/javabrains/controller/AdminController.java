...
import com.webbuild.javabrains.Operations.TokenBuilder;
...
public class AdminController {
	...
	public ModelAndView resetPassword(@RequestParam("Email") String UserEmail, HttpServletRequest request){
		...
		if (user != null) {
			...
			TokenBuilder.constructResetTokenEmail(appUrl, request.getLocale(), token, user);//send information to email generator method
